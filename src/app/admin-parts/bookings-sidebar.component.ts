...
import { calendarClearOutline, logOutOutline, homeOutline, searchOutline, calendarOutline, flagOutline, barChartOutline } from 'ionicons/icons';
...
export class BookingsSidebarComponent {
  ...
  constructor() { addIcons({ calendarClearOutline, logOutOutline, homeOutline, searchOutline, calendarOutline, flagOutline, barChartOutline }); }
