...
describe('AdminAvailabilityPage', () => {
  it('mostra fasce, indisponibilità ed errori alla risposta HTTP', async () => {
    ...
    await fixture.whenStable();
    http.expectOne('/api/v1/admin/spaces/1/availability').flush({ data: [
      { availabilityId: 1, validFrom: '2026-09-01', validUntil: '2026-09-30', weekday: 1, startTime: '09:00', endTime: '11:00', isRetired: false },
      { availabilityId: 2, validFrom: '2026-10-01', validUntil: '2026-10-31', weekday: 2, startTime: '12:00', endTime: '13:00', isRetired: true },
    ] });
    ...
    await fixture.whenStable();
    expect(fixture.nativeElement.querySelector('.availability-rows')).toBeTruthy();
    expect(fixture.nativeElement.querySelector('.availability-rows').getAttribute('tabindex')).toBe('0');
    expect(fixture.nativeElement.querySelector('[aria-label="Fasce configurate"]').textContent).toContain('09:00–11:00');
    expect(fixture.nativeElement.querySelector('[aria-label="Fasce configurate"]').textContent).not.toContain('12:00–13:00');
    fixture.nativeElement.querySelector('.history-toggle').click();
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelector('[aria-label="Fasce configurate"]').textContent).toContain('12:00–13:00');
