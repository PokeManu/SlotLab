...
describe('ReportCreatePage', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        provideRouter([]),
        { provide: ActivatedRoute, useValue: { snapshot: { paramMap: convertToParamMap({ spaceId: '1' }) } } },
    ...
    http.expectOne('/api/v1/spaces/1').flush({ data: { id: 1, name: 'Aula', building: { name: 'Edificio' }, floor: 1, type: 'study_room', capacity: 10, accessible: true, services: [] } });
  });
