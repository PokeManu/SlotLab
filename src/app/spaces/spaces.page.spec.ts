...
describe('SpacesPage', () => {
  ...
  it('mantiene più spazi nei preferiti', () => {
    ...
    http
      .expectOne('/api/v1/favorites/1')
      .flush({ data: { spaceId: 1, isFavorite: true } });
    component.toggleFavorite('2');
    http
      .expectOne('/api/v1/favorites/2')
      .flush({ data: { spaceId: 2, isFavorite: true } });
